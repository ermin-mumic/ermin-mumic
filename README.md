...
### 🚗 Parkon-Bot | Python • Playwright • GCloud
...
* **The Role:** Lead Backend & Logic (Team Project).
* **The Tech:** High-performance synchronization of GPS positions, dynamic play-area shrinking and tactical power-ups.
* **[View Repository Backend Server](https://github.com/kiransain/sopra-fs25-group-26-server.git) | [View Repository Frontend Client](https://github.com/kiransain/sopra-fs25-group-26-client.git)**
